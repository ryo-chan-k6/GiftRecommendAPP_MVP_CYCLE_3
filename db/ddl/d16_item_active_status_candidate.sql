...
-- Issue: #1230
-- 正本: docs/06_実装設計/database/item_active_status_candidate_テーブル定義書.md
-- 制約: docs/06_実装設計/batch/BATCH-004_楽天既存商品再確認バッチ仕様書.md §18.1 No.7 / §18.1.1
-- 適用順: D01〜D15 および外部商品データ連携系（batch_run_log / item / raw_product_metadata / api_call_log）作成後。
-- 物理 FK なし（LOGICAL + Index）。Online 参照なし。
