...
-- Issue: #1080
-- 正本: docs/06_実装設計/database/metric_log_テーブル定義書.md
-- 適用順: D01〜D14 適用後（recommendation_run LOGICAL 参照）。
-- Tier 2 分布 Metric は reco_score_distribution_metric（D11）を正本とする。
