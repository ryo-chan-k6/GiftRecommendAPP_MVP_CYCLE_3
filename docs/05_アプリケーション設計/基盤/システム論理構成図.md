...
| `Semantic Extractor`          | 入力文からSemantic Conceptを抽出              |
...
| `Item Semantic Extractor`   | 商品Semantic抽出                                          |
...
flowchart TD
    ...
    I --> B4[batch/reco: Item Semantic Extractor]
