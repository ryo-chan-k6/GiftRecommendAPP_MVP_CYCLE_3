...
| Product Detail Modal State          | product_detail_modal_state          | 画面・UI                 | 画面状態                    | web                           | OL        | ○       | 商品詳細表示状態                          |
...
| Product Detail Modal State   | 商品詳細表示状態     | 商品詳細画面 / モーダル | ○       |
...
| API                                          | 主な入出力リソース                             |
| -------------------------------------------- | ---------------------------------------------- |
| `POST /recommendations`                      | Recommendation Request / Recommendation Result |
| `POST /recommendations/{result_id}/feedback` | Recommendation Feedback                        |
| `GET /masters/relationships`                 | Relationship Master                            |
| `GET /masters/occasions`                     | Occasion Master                                |
