...
flowchart LR
    ...
    subgraph BATCH[batch]
        ...
        B2[Raw Product Object Writer]
        B3[Raw Product Metadata Writer]
        B4[Raw Product Reader]
        B5[Staging Transformer]
        B6[Item Updater]
        B7[Item Semantic Generator]
        B8[Item Feature Generator]
        B9[Item Embedding Generator]
        B10[Evaluation Runner]
        B11[Batch Log Writer]
    end
