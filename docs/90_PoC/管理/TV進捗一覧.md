...
| ---- | ---- |
| 配置 | `docs/90_PoC/管理/` |
| 更新日 | 2026-07-22（TV-005 develop 着・TV-006 計測開始） |
...
| TV-006 | `進行中` | Epic [#1571](https://github.com/ryo-chan-k6/GiftRecommendAPP_MVP_CYCLE_3/issues/1571) / Task [#1572](https://github.com/ryo-chan-k6/GiftRecommendAPP_MVP_CYCLE_3/issues/1572) | local 件数・HNSW 計測・結果 doc 済み（暫定 **Go**）。Epic develop 着後に完了 |
