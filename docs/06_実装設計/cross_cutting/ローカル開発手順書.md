...
| PUB-002 が 500 `GRS-REC-012` かつ ranked_items is required | retrieval / ranking が stub のまま（§10.4.8）。候補取得以降の本番化が後続 |
...
| API-PUB-002 縦串 | §10.4〜§10.4.8 — UserFeature Postgres 配線後も ranked_items stub で GRS-REC-012（#1274） |
