...
| PUB-002 が 500 `GRS-REC-005` かつ user_semantic not found | UserSemantic が InMemory のまま（§10.4.6）。Postgres 永続配線が後続 |
...
| API-PUB-002 縦串 | §10.4〜§10.4.6 — RunValidation Postgres 配線後も UserSemantic 未永続で GRS-REC-005（#1269） |
