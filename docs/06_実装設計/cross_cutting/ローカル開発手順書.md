...
| 手動実行 | **blocked** | Docker daemon 未起動のため未実施。復旧後に §9.2 を再実施 |

証跡: `ai-logs/experiments/2026-07-17-scr-post-mvp-regression-e2e.md`

後続: Docker 復旧後の合否更新／D2（Playwright）。
...
| 2026-07-17 | §10.4.16 を追加。SCR-005〜007 回帰 E2E シナリオ定義（Issue #1419）。実行は Docker 未起動で blocked |
