...
| 6 | `evaluation_run.model_version_id` の FK 方針 | **LOGICAL FK 維持**（物理 FK なし）。`evaluation_run_テーブル定義書` §17.1 No.4・§9 `idx_evaluation_run_model_version` | Human | Issue #567 確定 |
