...
def scaffold_batch_settings(*, app_env: AppEnv = AppEnv.DEV) -> BatchSettings:
    ...
    return BatchSettings(
        ...
        batch_feedback_analysis_period_start=None,
        batch_feedback_analysis_period_end=None,
        batch_feedback_analysis_aggregation_scope=None,
        batch_feedback_analysis_feedback_types=None,
        batch_feedback_analysis_semantic_config_version_id=None,
        batch_feedback_analysis_max_feedback_rows=None,
        batch_feedback_analysis_dry_run=False,
