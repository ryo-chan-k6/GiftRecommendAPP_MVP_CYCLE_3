"""BATCH-004 helpers: object_key / content_hash / fetch_cursor scope fingerprint.

Same semantics as BATCH-003 item_pseudo_diff (item_search Raw path).
"""
...
def cursor_scope_fingerprint(
    *,
    ...
    """Fingerprint for fetch_cursor UNIQUE scope (recheck: genre_id is NULL)."""
